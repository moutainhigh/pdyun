...
public class AppExceptionHandler extends AbstractHandlerMethodExceptionResolver {
    ...
    protected ModelAndView doResolveHandlerMethodException(HttpServletRequest request, HttpServletResponse response, HandlerMethod handlerMethod, Exception exception) {
        ...
        if (responseBodyAnn != null || restControllerAnn != null) {
            try {
                return handleResponseBody(request, response, exception.getMessage());
     ...
     * @throws IOException
     */
    private ModelAndView handleResponseBody(HttpServletRequest request, HttpServletResponse response, String errorMessage) throws ServletException, IOException {
        ...
        String responseValue = JSON.toJSONString(new ResultError(errorMessage));
