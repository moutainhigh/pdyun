...
public class CheckUtils {
    ...
    static {
        ...
        lianHangHaoMap.put("济宁银行","313461000012");
        ...
        String provinces = "北京市、上海市、广东省、安徽省、重庆市、福建省、甘肃省、广西自治区、贵州省、海南省、河北省、河南省、黑龙江省、" +
    ...
    public static List<String> findBankName(){
        Set<String> set = lianHangHaoMap.keySet();
