...
function ImageFlow() {
    ...
    this.defaults =
	{
	    ...
	    percentLandscape: 200,            /* Scale landscape format */
	    percentOther: 150,            /* Scale portrait and square format */
	    ...
	    sliderWidth: 30,             /* Width of the slider in px */
	    ...
	    xStep: 300             /* Step width on the x-axis in px */
	};
    ...
    this.loadingStatus = function () {
        ...
        var loadingTxt = document.createTextNode('');
                ...
                else
                {
                    try
                    {
                        ...
                        if (newImageW && newImageH)
                        {
                           ...
                           image.style.top = newImageTop-50 + 'px';
                        }
