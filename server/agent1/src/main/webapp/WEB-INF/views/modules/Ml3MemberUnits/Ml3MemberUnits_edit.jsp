        ...
        <form>
            ...
            <div class="form-group row">
                ...
                <%--<div class="col-md-2">--%>
                    ...
                    <%--<input type="text" class="form-control span1" name="mobile" placeholder="请输入11位手机号码" required value="${model.mobile}"/>--%>
                <%--</div>--%>
                <%--<div class="col-md-2">--%>
                    <%--<label>返VIP合伙人手续费比例</label>--%>
                    <%--<input type="text" class="form-control span1" name="unitsReturnFeePercent" placeholder="请输入数字格式的手续费比例" required value="${model.unitsReturnFeePercent}"/>--%>
                <%--</div>--%>
            </div>
            <%--<div class="form-group row">--%>
                <%--<div class="col-md-2">--%>
                    <%--<label>返VIP合伙人服务费比例</label>--%>
                    <%--<input type="text" class="form-control span1" name="unitsReturnServicePercent" placeholder="请输入数字格式的手续费比例" required value="${model.unitsReturnServicePercent}"/>--%>
                <%--</div>--%>
            <%--</div>--%>
