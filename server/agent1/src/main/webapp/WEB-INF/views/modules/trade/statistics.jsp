    ...
    <div>
        <label class="input-inline">
            ...
            <c:if test="${isUnits}">
                ...
                <span>合伙人：</span>
                <select style="width:200px; height:35px;border: 1px solid #D4D4D4; border-radius: 5px 5px 5px 5px;" id="agentId">
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
        ...
        <tr>
            ...
            <th field="agentAccount" align="center" data-options="width:80">合伙人账号</th>
            <th field="uname" align="center" data-options="width:80">会员姓名</th>
...
<script>
    ...
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["mobile", "agentMobile", "startDate", "endDate", "agentId", "userMobile", "chnName"]
        };
