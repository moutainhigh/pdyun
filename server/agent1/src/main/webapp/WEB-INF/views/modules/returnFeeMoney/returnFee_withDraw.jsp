...
<form class="form-horizontal" style="display: none;">
    ...
    <div class = "form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="chnName" placeholder="请输入开户名称" value="${memberUnits.name}"/>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-2 col-sm-offset-2">
            <button type="submit" class="btn btn-primary" onclick="infoAjaxSubmitForWithdraw(this, '${ctx}/returnFeeWithdraw/returnFeeWithDraw')">提交</button>
        </div>
    </div>
</form>
<div id="moneyRecord">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/returnFeeWithdraw/findReturnFeeRecord?id=${id}',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
    ...
    <script type="text/javascript">
        ...
        $("li").on("click", function () {
            ...
            if($(this).index() === 0){
                ...
                window.location.href = ctx + '/returnFeeWithdraw/withdrawReturnFee';
