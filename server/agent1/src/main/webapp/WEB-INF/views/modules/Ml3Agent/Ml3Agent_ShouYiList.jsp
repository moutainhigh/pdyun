...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
        ...
        <tr>
            ...
            <th field="mobile" align="center" data-options="width:100">代理手机号</th>
            <th field="difMoney" align="center" data-options="width:100">客户盈亏</th>
            <th field="rechargeMoney" align="center" data-options="width:100">客户累计充值金额</th>
            <th field="outMoney" align="center" data-options="width:100">客户累计提现金额</th>
            <th field="money1" align="center" data-options="width:100">客户余额</th>
        </tr>
        </thead>
    </table>
</div>
...
<script>
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["realName","createTimeMin","createTimeMax"]
        };
