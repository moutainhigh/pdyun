...
<div region="north" style="padding:5px;" border="false">
    ...
    <div>
        <label class="input-inline">
            ...
            <span>持仓状态：</span>
            <select class="" style="height:35px;" id="status">
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/trade/tradeHoldOperateCenter?id=${id}',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
        ...
        <tr>
            ...
            <%--<th field="pointValue" align="center" data-options="">点值</th>--%>
            <%--<th field="profitMax" align="center" data-options="">止盈(%)</th>--%>
            <%--<th field="lossMax" align="center" data-options="">止损(%)</th>--%>
            <%--<th field="offPoint" align="center" data-options="">点数</th>--%>
...
<script>
    ...
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["uname","mobile", "status"]
        };
