...
<div region="north" style="padding:5px;" border="false">
    ...
    <div style="overflow: hidden;">
        <label class="input-inline juntuan_phone">
            <span>合伙人:</span>
            <select id="agentId" class="form-control span1" style="width: 10%; display: inline-block">
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/user/userinnerunits?id=${id}',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
        ...
        <thead>
        <tr>
            <th field="agentRealName" align="center" data-options="width:100">所属代理</th>
...
<script>
    ...
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["mobile","chnName","uMoneyMin","uMoneyMax","orderKey","orderValue", "agentId"]
        };
