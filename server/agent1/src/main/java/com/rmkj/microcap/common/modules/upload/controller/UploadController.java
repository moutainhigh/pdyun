...
public class UploadController extends BaseController {
    ...
    public void ckeditorUpload(MultipartHttpServletRequest request, PrintWriter printWriter, HttpServletRequest servletRequest) {
        ...
        try {
            ...
            // 服务地址根路径
            String rootUrl = request.getScheme().concat("://").concat(request.getServerName()).concat(request.getServerPort() == 80 ? "" : ":".concat(request.getServerPort()+"")).concat(request.getContextPath());
