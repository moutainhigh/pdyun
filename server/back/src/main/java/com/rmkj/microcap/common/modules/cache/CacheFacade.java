...
import com.rmkj.microcap.common.utils.JsonMapper;
...
public class CacheFacade {
    ...
    public static void set(String key, Object value, int exp) {
        ...
        cacheBean.setJsonValue(JsonMapper.toJsonString(value));
        cache.set(ProjectConstants.PROJECT_NAME + "_" + key, JsonMapper.toJsonString(cacheBean), exp);
    }
