package com.rmkj.microcap.common.modules.money.out.ytb.utils;
...
public class Utils {
	 ...
	 * 请求地址
	 */
	protected static String BASE_URL = "http://settle.juhuibaopay.com/";
	...
	public static String buildParams(Map<String, String> param)
			throws Exception {
		StringBuffer url = new StringBuffer();
		Set<String> set = param.keySet();
		Iterator<String> it = set.iterator();
	...
	public static String receiveBySendPost(String urlStr, String encoding,String params)
			throws Exception {
		InputStream is = null;
		BufferedReader br = null;
		InputStreamReader isr = null;
