package com.rmkj.microcap.modules.sys.utils;
...
import com.rmkj.microcap.common.modules.sys.utils.LocalCacheUtils;
...
import com.rmkj.microcap.modules.sys.dao.IMl3AgentDao;
import com.rmkj.microcap.modules.sys.dao.IMl3PermissionDao;
import com.rmkj.microcap.modules.sys.dao.IMl3RoleDao;
...
public class UserUtils {
     ...
     * @return 取不到返回null
     */
    public static Ml3AgentBean getByLoginName(String loginName) {
        Ml3AgentBean user = (Ml3AgentBean) LocalCacheUtils.get(USER_CACHE, USER_CACHE_LOGIN_NAME_ + loginName);
        if (user == null) {
...
//        LocalCacheUtils.remove(USER_CACHE, USER_CACHE_LOGIN_NAME_ + user.getOldLoginName());
    ...
    public static boolean curUserHasSuperRole() {
        ...
        Ml3AgentBean sysUserBean = com.rmkj.microcap.modules.sys.utils.UserUtils.getUser();
