...
public enum StatusCode {
    ...
    @CodeAnnot("出金失败") WEIPENG_DAI_PAY_FAIL(11),
    @CodeAnnot("出金功能存在问题") OUT_MONEY_FAULT(12),
    @CodeAnnot("存在相同信息用户") OPERATECENTERUSER_EXIST(13),
    @CodeAnnot("已没有认购次数") SUB_TIMES_OVER(14),
    @CodeAnnot("用户不存在") USER_NOT_EXIST(15);
