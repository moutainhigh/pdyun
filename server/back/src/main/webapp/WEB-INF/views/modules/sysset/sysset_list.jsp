...
<div region="north" style="padding:5px;" border="false">
    ...
    <shiro:hasPermission name="sysset:delete">
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
        ...
        <thead>
        <tr>
            <th field="userId" align="center" data-options="width:100">用户编号</th>
            <th field="roleId" align="center" data-options="width:100">角色编号</th>
        </tr>
        </thead>
    </table>
</div>
<div id="addWindow" url="${ctx}/sysset/add"></div>
<div id="editWindow" url="${ctx}/sysset/edit"></div>
<%@ include file="/WEB-INF/views/include/footer.jsp" %>
<script>
    $(function () {
        var operationObj = {
            deleteUrl: ctx + '/sysset/delete'
        };
