...
<div id="addWindow" url="${ctx}/agentuser/add"></div>
<div id="editWindow" url="${ctx}/agentuser/edit"></div>
<%@ include file="/WEB-INF/views/include/footer.jsp" %>
<script>
    $(function () {
        var operationObj = {
            deleteUrl: ctx + '/agentuser/delete'
        };
