...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/Ml3OperateCenter/userList',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
...
<div id="addWindow" url="${ctx}/Ml3OperateCenter/addOperateCenterUser"></div>
<div id="editWindow" url="${ctx}/Ml3OperateCenter/editOperateCenyerUser"></div>
