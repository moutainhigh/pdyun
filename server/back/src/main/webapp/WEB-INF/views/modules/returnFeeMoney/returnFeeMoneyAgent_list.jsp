...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/returnFeeMoney/recordAgentList',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
        ...
        <tr>
            ...
            <th field="realName" align="center" data-options="width:100">合伙人姓名</th>
...
<script>
    ...
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["serialNo", "thirdSerialNo", "realName","agentMobile","startDate","endDate","reviewStatus","status"]
        };
