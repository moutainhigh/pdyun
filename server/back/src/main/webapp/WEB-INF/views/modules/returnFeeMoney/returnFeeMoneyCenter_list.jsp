...
<div region="north" style="padding:5px;" border="false">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <span>市场管理部名称：</span>
            <input class="easyui-textbox" data-options="width:150,height:35" type="text" id="centerName" />
        </div>
        <%--<div class="col-sm-2">--%>
            <%--<span>合伙人手机号：</span>--%>
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/returnFeeMoney/recordOpearteCenterList',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
        ...
        <tr>
            ...
            <th field="centerName" align="center" data-options="">市场管理部名称</th>
            <th field="realName" align="center" data-options="width:100">市场管理部姓名</th>
...
<script>
    ...
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["serialNo", "thirdSerialNo", "centerName","agentMobile","startDate","endDate","reviewStatus","status"]
        };
    ...
    function exportAlaExcel(){
        window.location.href = '${ctx}/returnFeeMoney/exportAlaExcel?ids=' + _ids().join(',');
    }
    function _ids(){
        var rows = $('#listDataGrid').datagrid('getChecked');
        var ids = [];
