...
<div region="north" style="padding:5px;" border="false">
    ...
    <shiro:hasPermission name="Ml3Agent:addUnits">
        <button id="addInfoBt" class="btn btn-info margin-r10">添加</button>
    </shiro:hasPermission>
    <shiro:hasPermission name="Ml3Agent:editUnits">
...
<div id="addWindow" url="${ctx}/Ml3Agent/addUnits"></div>
<div id="editWindow" url="${ctx}/Ml3Agent/editUnits"></div>
