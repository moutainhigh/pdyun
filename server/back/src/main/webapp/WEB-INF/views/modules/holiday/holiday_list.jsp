...
<div region="north" style="padding:5px;" border="false">
    ...
    <shiro:hasPermission name="holiday:edit">
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
        ...
        <thead>
        <tr>
            <th field="name" align="center" data-options="width:100">假日名称</th>
            <th field="startDate" align="center" data-options="width:100">开始日期</th>
            <th field="endDate" align="center" data-options="width:100">结束日期</th>
...
<div id="addWindow" url="${ctx}/holiday/add"></div>
<div id="editWindow" url="${ctx}/holiday/edit"></div>
<%@ include file="/WEB-INF/views/include/footer.jsp" %>
<script>
    $(function () {
        var operationObj = {
            deleteUrl: ctx + '/holiday/delete'
        };
