...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/agent/getAgentReview?id=${id}',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
        ...
        <tr>
            ...
            <th field="loginname" align="center" data-options="width:100">后台操作人员</th>
            <th field="resultStatus" align="center" data-options="width:100,
                formatter:function(value,row,index){
                    return value == '1' ? '通过' : '未通过';
                }
            ">审核结果</th>
            <th field="readStatus" align="center" data-options="width:100,
                formatter:function(value,row,index){
