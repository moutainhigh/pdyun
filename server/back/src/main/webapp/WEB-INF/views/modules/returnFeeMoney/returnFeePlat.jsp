...
<form class="form-horizontal" style="display: none;">
    <div class="form-group">
        <label class="col-sm-2 control-label" for = "feeType">类型</label>
        <div class="col-sm-3">
    ...
    <div class = "form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="bankName" placeholder="请输入银行开户行"/>
        </div>
    </div>
    <div class = "form-group">
        <label class="col-sm-2 control-label" for = "openBankName">开户行支行</label>
        <div class="col-sm-3">
            <input type="text" class="form-control" name="openBankName" placeholder="请输入开户行支行"/>
        </div>
    </div>
    <div class = "form-group">
    ...
    <div class = "form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="bankAccount" placeholder="请输入银行账户"  />
        </div>
    </div>
    <div class = "form-group">
        <label class="col-sm-2 control-label" for = "chnName">开户名称</label>
        <div class="col-sm-3">
            <input type="text" class="form-control" name="chnName" placeholder="请输入开户名称" />
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-2 col-sm-offset-2">
            <button type="submit" class="btn btn-primary" onclick="infoAjaxSubmitForWithdraw(this, '${ctx}/returnFeeMoney/saveMoneyPlatRecord')">提交</button>
        </div>
    </div>
</form>
...
<div id="moneyRecord">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
           data-options="
	                url: '${ctx}/returnFeeMoney/moneyPlatRecord',
	                lines: true,
	                idField: 'id',
	                striped: true,
	                fitColumns:true,
        ...
        <thead>
        <tr>
            <th field="feeType" align="center" data-options="width:100,
                  formatter:function(value,row,index){
                        return value == '1' ? '手续费' : '服务费';
                    }
            ">类型</th>
            ...
            <th field="chnName" align="center" data-options="width:100">开户人姓名</th>
    ...
    <script type="text/javascript">
        ...
        $("li").on("click", function () {
            ...
            if($(this).index() === 0){
                ...
                window.location.href = ctx + '/returnFeeMoney/moneyPlat';
        ...
        function exportExcel(){
            window.location.href = '${ctx}/returnFeeMoney/exportExcelHold?';
        }
    </script>
</body>
</html>
