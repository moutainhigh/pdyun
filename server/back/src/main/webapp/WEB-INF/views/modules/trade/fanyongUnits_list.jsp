...
<div region="north" style="padding:5px;" border="false">
    ...
    <div>
        <label class="input-inline">
            <span>VIP合伙人名称：</span>
            <input class="easyui-textbox" data-options="width:150,height:35" type="text" id="unitsName" name="unitsName"/>
            <span>开 始 时 间：</span>
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
        ...
        <thead>
        <tr>
            <th field="unitsRealName" align="center" data-options="width:100">代理名称</th>
...
<script>
    $(function () {
        ...
        var toolBarInitObj = {
            queryColumns: ["unitsName","userChnName","userMobile","money","serialNo","sellTimeMin","sellTimeMax"]
        };
