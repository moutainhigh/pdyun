...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-treegrid" style="width: 100%;" singleSelect="true"
        ...
        <tr>
            ...
            <th field="isShow" align="left" data-options="width:100,${fns:getDictTypeFormatterTag('sys_menu_show')}">
                是否在菜单中显示
            </th>
...
<div id="addWindow" url="${ctx}/sysmenu/add"></div>
<div id="editWindow" url="${ctx}/sysmenu/edit"></div>
<%@ include file="/WEB-INF/views/include/footer.jsp" %>
<script>
    $(function () {
        var operationObj = {
            deleteUrl: ctx + '/sysmenu/delete'
        };
