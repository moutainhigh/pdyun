...
<div region="north" style="padding:5px;" border="false">
    ...
    <%--<button class="btn btn-info margin-r10" onclick="addUntisBondMoney()">追加保证金</button>--%>
...
<div region="center" style="padding:5px;" border="false">
    <table id="listDataGrid" class="easyui-datagrid"  style="width: 100%;" singleSelect="true" pagination="true"
        ...
        <thead>
        <tr>
            <th field="operateCenterName" align="center" data-options="width:100">所属市场管理部</th>
            <th field="name" align="center" data-options="width:100">VIP合伙人名称</th>
            <th field="mobile" align="center" data-options="width:100">VIP合伙人手机号</th>
            ...
            <%--<th field="moneyLimit" align="center">保证金余额限制(元)</th>--%>
            <th field="unitsReturnFeeMoney" align="center">返手续费余额</th>
            <th field="unitsReturnFeeTotalMoney" align="center">返手续费累计金额</th>
            <th field="unitsReturnFeePercent" align="center">返手续费比例</th>
            <th field="unitsReturnServiceMoney" align="center">返服务费余额</th>
            <th field="unitsReturnServiceTotalMoney" align="center">返服务费累计金额</th>
            <th field="unitsReturnServicePercent" align="center">返服务费比例</th>
...
<script>
    ...
    function addUntisBondMoney(){
        ...
        layer.prompt({
            ...
            /* 验证金额 */
            if(!/^\d+(\.\d{0,2})?$/.test(pass)){
                layer.msg("追加金额不正确！", function () {
            ...
            addMOney = pass;
            $.ajax({
                url: '${ctx}/Ml3MemberUnits/addUnitsBondMoney',
                type: 'POST',
                data: {
                    id: row.id,
                    addUnitsBondMoney: addMOney
                },
